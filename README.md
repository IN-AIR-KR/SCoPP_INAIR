...
MICPP_INAIR references the SCoPP paper and the authors' MIT-licensed official implementation, and adds indoor coverage-planning adaptations for this repository's use cases.
